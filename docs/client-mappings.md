...
Updated clients advertise `capabilities.file_api` with version `1` and a list of
...
same-mapping manifest/replace/delete batches. REST and MCP callers keep their
