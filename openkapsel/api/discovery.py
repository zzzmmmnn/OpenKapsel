        ...
        payload["capabilities"]["mappings"] = {
            ...
            "rpc": {
                ...
                "families": {
                    ...
                    "git": {"version": 2, "fallback": "none", "generic_rpc_exposed": True, "server_rpc": True, "mcp_read_tools": ["git_status", "git_diff", "git_log", "git_show", "git_ls_files", "git_diff_stat"], "sync_reads": ["status", "diff", "log", "show", "ls_files", "diff_stat"], "task_writes": ["add", "commit", "restore", "checkout", "fetch", "pull", "clone"]},
                    ...
                    "ssh": {"version": 1, "fallback": "none", "privileged": True,
