...
def _token_card(
    ...
    mcp_actions = (
        ...
        "Copy MCP URL + control token</button>"
        f'<button type="button" class="secondary" onclick="copyMcpJson(\'{mcp_url_id}\',\'{control_id}\',this)">'
        "Copy MCP JSON</button></div>"
    )
    card = card.replace(
