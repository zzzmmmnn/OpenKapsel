...
ENDPOINTS: tuple[EndpointSpec, ...] = (
    ...
    *(EndpointSpec(
        "archive_" + operation, frozenset(("GET",)), re.compile(r"/archive/(?P<operation>" + operation + r")"),
        "_handle_archive", invocation="param_query", parameter="operation",
        transfer_slot=True, context_mode="optional_query", context_operations=(("GET", "archive." + operation),),
        discovery_key="archive_" + operation,
    ...
    EndpointSpec("server_rpc", frozenset(("POST",)),
        ...
        request_body=True, transfer_slot=True, discovery_key="server_rpc"),
    ...
    EndpointSpec("mapping_rpc", frozenset(("POST",)),
        ...
        request_body=True, transfer_slot=True, discovery_key="mapping_rpc"),
