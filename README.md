...
- The matching control token is sent as `Authorization: Bearer ...` for mutations, Shell, Context, Memory, and MCP.
...
- [Shell tasks and MCP](docs/shell-and-mcp.md): task lifecycle, streaming, connection limits, process control, and MCP transport.
